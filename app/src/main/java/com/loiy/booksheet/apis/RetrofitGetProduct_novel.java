...
public class RetrofitGetProduct_novel {

    //declaring an instance of RetrofitGetProduct_novel.
    private static RetrofitGetProduct_novel instance = null;
    ...
    private RetrofitGetProduct_novel() {

        Retrofit retrofit = new Retrofit.Builder().baseUrl(ApiUrl.GET_NOVEL)
    ...
    public static synchronized RetrofitGetProduct_novel getInstance() {
        if (instance == null) {
            instance = new RetrofitGetProduct_novel();
        }
        return instance;
    }
...
}//end of RetrofitGetProduct_novel class.
