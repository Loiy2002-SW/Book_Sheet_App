...
public class RetrofitGetProduct_self {

    //declaring an instance of RetrofitGetProduct_self.
    private static RetrofitGetProduct_self instance = null;
    ...
    private RetrofitGetProduct_self() {

        Retrofit retrofit = new Retrofit.Builder().baseUrl(ApiUrl.GET_SELF)
    ...
    public static synchronized RetrofitGetProduct_self getInstance() {
        if (instance == null) {
            instance = new RetrofitGetProduct_self();
        }
        return instance;
    }
...
}//end of RetrofitGetProduct_self class.
